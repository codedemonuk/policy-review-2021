...
We are on track to make progress on moving our 5 major businesses systems off premise and to hosted/cloud hosted platforms.
...
Infrastructure servers  are being moved from on premise to Azure, this is an ongoing project, target date for completion Q1 2022/23. Azure is first option for any new server requests.
